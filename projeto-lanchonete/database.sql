...
--
-- Host: localhost    Database: projeto-lanchonete
-- ------------------------------------------------------
...
INSERT INTO `categorias` VALUES (1,'Adicional'),(2,'Bebida'),(3,'Lanche');
...
CREATE TABLE `pedidos` (
  ...
  CONSTRAINT `pedidos_idcliente_foreign` FOREIGN KEY (`idCliente`) REFERENCES `clientes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
